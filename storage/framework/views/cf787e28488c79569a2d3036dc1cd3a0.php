...
<div class="mt-16">
    <div class="grid grid-cols-12 md:grid-cols-12">
        <div
            ...
            <div class="container-fluid">
                ...
                <form action="<?php echo e(route('cpf.index')); ?>" data-form-consult-cpf="">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
    ...
    <div class="flex justify-center mt-16 px-0 sm:items-center sm:justify-between">
        <div class="ml-4 text-center text-sm text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0">
            Api desenvolvida por Pedro de Souza - Laravel v<?php echo e(Illuminate\Foundation\Application::VERSION); ?>

            (PHP v<?php echo e(PHP_VERSION); ?>) - <a href="https://github.com/Luckycaat">https://github.com/Luckycaat</a>
        </div>
    </div>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH C:\Users\Pichau\Projetos\api.gosat\resources\views/welcome.blade.php ENDPATH**/ ?>